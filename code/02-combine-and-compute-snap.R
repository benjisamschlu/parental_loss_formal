...
sipp2021 <- read_csv(here("data_private", "sipp_2021-snap.csv")) |>
...
## Save data -------------------------------------------------------------------
write.csv(
    multistate_lt, here("data", "multistate-lt-snap.csv"), row.names = FALSE
)
write.csv(
    se_multistate_lt, here("data", "se-multistate-lt-snap.csv"), 
    row.names = FALSE
)
write.csv(df_sipp_n, here("data", "sipp_n-snap.csv"), row.names = FALSE)
