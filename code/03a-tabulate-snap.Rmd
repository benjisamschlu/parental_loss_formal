...
threshold <- 10
sipp_n <- read_csv(here("data", "sipp_n_snap.csv"))
...
us_mlt_num <- read_csv(here("data", "multistate-lt_snap.csv")) |>
    mutate(Age = if_else(
        str_detect(x, "Inf"),
...
us_mlt_num |>
    filter(sex == "all", race == "all") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-all.csv"))
```
...
us_mlt_num |>
    filter(sex == "female", race == "all") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-female.csv"))
```
...
us_mlt_num |>
    filter(sex == "male", race == "all") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-male.csv"))
```
...
us_mlt_num |>
    filter(sex == "all", race == "hispanic") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-hispanic.csv"))
```
...
us_mlt_num |>
    filter(sex == "female", race == "hispanic") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-hispanic-female.csv"))
```
...
us_mlt_num |>
    filter(sex == "male", race == "hispanic") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-hispanic-male.csv"))
```
...
us_mlt_num |>
    filter(sex == "all", race == "non-hispanic asian") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhasian.csv"))
```
...
us_mlt_num |>
    filter(sex == "female", race == "non-hispanic asian") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhasian-female.csv"))
```
...
us_mlt_num |>
    filter(sex == "male", race == "non-hispanic asian") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhasian-male.csv"))
```
...
us_mlt_num |>
    filter(sex == "all", race == "non-hispanic black") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhblack.csv"))
```
...
us_mlt_num |>
    filter(sex == "female", race == "non-hispanic black") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhblack-female.csv"))
```
...
us_mlt_num |>
    filter(sex == "male", race == "non-hispanic black") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhblack-male.csv"))
```
...
us_mlt_num |>
    filter(sex == "all", race == "non-hispanic white") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhwhite.csv"))
```
...
us_mlt_num |>
    filter(sex == "female", race == "non-hispanic white") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhwhite-female.csv"))
```
...
us_mlt_num |>
    filter(sex == "male", race == "non-hispanic white") |>
    select(-c(race, sex)) |>
    write.csv(here("data", "multistate_life_tables",  "snapshot","us2020-nhwhite-male.csv"))
```
