...
model {
  ...
  for (r in 1:N_RACE) {
    ...
    p_a_lost_mom[r] ~ normal(phi_mom[r], p_a_lost_mom_se[r]);
    p_a_lost_dad[r] ~ normal(phi_dad[r], p_a_lost_dad_se[r]);
    m_a_lost_mom[r] ~ normal(theta_mom[r], m_a_lost_mom_se[r]);
    m_a_lost_dad[r] ~ normal(theta_dad[r], m_a_lost_dad_se[r]);
  }
...
generated quantities {
  ...
  for (r in 1:N_RACE) {
    ...
    // projection
    p_a_lost_mom_pp[r] = normal_rng(phi_mom[r], p_a_lost_mom_se[r]);
    p_a_lost_dad_pp[r] = normal_rng(phi_dad[r], p_a_lost_dad_se[r]);
    m_a_lost_mom_pp[r] = normal_rng(theta_mom[r], m_a_lost_mom_se[r]);
    m_a_lost_dad_pp[r] = normal_rng(theta_dad[r], m_a_lost_dad_se[r]);
  }
}
